<div class="row">
	...
	<div class="col-sm-7">
		...
		Para: <span class="original_price">R$ <?php echo number_format($product_info['price'], 2);?></span>	
...
<div class="row">
	...
	<div class="col-sm-6">
		...
		<?php foreach($product_rates as $rates):?>
			<strong><?php echo $rates['user_name'];?></strong> - 
			<?php for($q=0;$q<intval($rates['points']); $q++):?>
				<img src="<?php echo BASE_URL;?>assets/images/star.png" border="0" height="15" />
			<?php endfor;?>
			<br/>
			"<?php echo $rates['comment'];?>"
			<hr/>
		<?php endforeach;?>
	</div>
</div>